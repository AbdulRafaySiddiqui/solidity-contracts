...
contract SNAFU is Context, IERC20, Ownable {
    ...
    string private _name = "SNAFU TOKEN";
    ...
    //Total 8% => 6% goes to liquidity providers and 2% is added to liquidity pool
    uint256 public _liquidityFee = 8;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    //means 75% from total collected liquidity(8% on every Transfer) will be used to rewarded liquidity providers
    uint256 public _lpRewardFromLiquidity = 75;
